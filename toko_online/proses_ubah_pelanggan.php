...
if($_POST){
    ...
    if(empty($nama_pelanggan)){
        ...
        include "koneksi2.php";
            ...
            $update=mysqli_query($conn,"update pelanggan set nama='".$nama_pelanggan."',
            alamat='".$alamat."', 
            telp='".$telp."'
            ...
            if($update){
                ...
                echo "<script>alert('Gagal update pelanggan');location.
                href='ubah_pelanggan.php?id_pelanggan=".$id_pelanggan."';</script>";
