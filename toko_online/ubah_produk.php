...
<body>
    ...
    <form action="proses_ubah_produk.php" method="post">
        ...
        value= "<?=$dt_produk['nama_produk']?>" class="form-control">

        Deskripsi :
        <input type="text" name="deskripsi" 
        value= "<?=$dt_produk['deskripsi']?>" class="form-control">
        ...
        Foto Produk :
        <input type="text" name="foto_produk" 
        value= "<?=$dt_produk['foto_produk']?>" class="form-control">

        <input type="submit" name="simpan"
        value="Ubah Produk" class="btn btn-primary">
